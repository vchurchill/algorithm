...
def West(m,a,b):
  ...
  for mprime in range(0,n):
    sum += S(n,nodes(n,a,b)[m],nodes(n,C1a,C1b)[mprime],a,b,C1a,C1b)*W1(mprime,C1a,C1b) +
    S(n,nodes(n,a,b)[m],nodes(n,C2a,C2b)[mprime],a,b,C2a,C2b)*W2(mprime,C2a,C2b) +
    S(n,nodes(n,a,b)[m],nodes(n,C3a,C3b)[mprime],a,b,C3a,C3b)*W3(mprime,C3a,C3b) +
    S(n,nodes(n,a,b)[m],nodes(n,C4a,C4b)[mprime],a,b,C4a,C4b)*W4(mprime,C4a,C4b)
  return sum
...
def Kest(l,a,b,c,d):
  Kest = 0
  for m in range(0,n):
    Kest += log(nodes(n,c,d)[l],nodes(n,a,b)[m])*West(m,a,b)
  return Kest

fest1 = 0
for l in range(0,n):
  fest1 += S(n,nodes(n,c,d)[l],point,c,d,c,d)*Kest(l,a,b,c,d)
...
fest2 = 0
for m in range(0,n):
  fest2 += log(point,nodes(n,a,b)[m])*West(m,a,b)
