...
def fT(l1,l2):
  ...
  for lprime1 in range(0,n):
    for lprime2 in range(0,n):
      sum += fP(lprime1,lprime2)*R(n,nodes(n,a1,b1)[l1],nodes(n,a2,b2)[l2],nodes(n,Pa1,Pb1)[lprime1],nodes(n,Pa2,Pb2)[lprime2],Pa1,Pb1,Pa2,Pb2)
  return sum
...
for l1 in range(0,n):
  for l2 in range(0,n):
    fest += fT(l1,l2)*R(n,nodes(n,a1,b1)[l1],nodes(n,a2,b2)[l2],point[0],point[1],a1,b1,a2,b2)
