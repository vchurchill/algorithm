...
ns1 = np.zeros(shape=(n*n,2))
nt1 = np.zeros(shape=(n*n,2))
ns2 = np.zeros(shape=(n*n,2))
nt2 = np.zeros(shape=(n*n,2))
for i in range(0,n*n):
  ns1[i,0] = nodes(n,a1,b1)[i]
  ns1[i,1] = nodes(n,a2,b2)[i]
